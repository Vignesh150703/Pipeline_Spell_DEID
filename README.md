...
1. **Prepare Input File**: Create or edit `LLM_input.txt` in the project root with your medical text.
...
```
**Solution**: Create `LLM_input.txt` in the project root with your medical text.
...
**6. Empty output**
- Check that `LLM_input.txt` contains text
